...
import { createSingleImp, handleError, } from "./library/implementation/storeImplementation";
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const singleEditionResult = yield createSingleImp(optionsWithBase58, landStoreDevnet, collectionAccount, createItemOptions);

...
import { getFileCategory, getFileType, isAnimatable, normalizeFileData, validateFileType, } from "../../../utility/utils";
import { Blob } from "node:buffer";
export function uploadFilesIrysInstruction(options, irysObj, uuid) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (options.metadata.files.file && !options.metadata.files.file.url) {
                const normalizedMainFile = yield normalizeFileData(options.metadata.files.file);
            ...
            if (options.metadata.files.cover && !options.metadata.files.cover.url) {
                const normalizedCoverFile = yield normalizeFileData(options.metadata.files.cover);
            ...
            const offchain_metadata = {
                ...
                animation_url: isAnimatable(main_file === null || main_file === void 0 ? void 0 : main_file.type)
